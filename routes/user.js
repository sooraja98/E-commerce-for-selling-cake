...
paypal.configure({
    ...
    client_id: "AfFNd2qFDc9rtgtrLA9YQO3Hcs2Tueav6iVlrZTvDPzT8oNNLWcQkzGFFmd_pcALKeBanIpZYky3mirA",
    client_secret: "ECe3UMFpNHcJOcqPPZBj-18EZQTJyt5BrGjg10us99wNueLJW1NGw3lYEEKYJ8GCWICwU1XgFkvmANQ6"
});
...
router.post("/user-login",userController.login,userController.getotpverification);
router.get("/user-login/otpverification", g);
router.post("/user-login/otpverification", userController.otpverfication);
// forgott password
router.get("/user-login/forgotpassword", userController.getforgetpassword);
